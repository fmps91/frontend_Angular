...
@Component({
  ...
  templateUrl: './buscar_paciente.component.html',
  styleUrls: ['./buscar_paciente.component.css']
})
export class BuscarPacienteComponent implements OnInit, AfterContentInit {
  notes: any[] = [];
  filterPost = '';
